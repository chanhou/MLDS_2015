...
SAMPLE read_struct_examples(char *file, STRUCT_LEARN_PARM *sparm)
{
  ...
  // if (y_exist){
    ...
    // map<string,string> mapp_label;  
    ifstream train_lab;
    train_lab.open("/home/pika/MLDS_2015_hw1/MLDS_HW1_RELEASE_v1/label/train.lab");
...
//if(count==0) cout<<endl;
    ...
    if(previous_ppl == ppl_name){
      ...
      // if (y_exist){
//	if(count==0) cout<<mapp_int[mapp_label[temp1]]<<endl;
...
//if(count==1){
//   for(auto & actual :examples[0].y.y_part ){
//     cout<<actual<<",";
//   }
//   cout<<endl;
//}
